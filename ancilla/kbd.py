...
def output( ta_letter, kw_tag ):
    print("".join(["""<input type="button" name="btn_kw_""",kw_tag,"""" value='""",ta_letter,"""' onClick="appendText('""",ta_letter,"""')"; />"""]))
...
for pos,ta_letters in enumerate(uyir_letters):
    output( ta_letters, "uyir_"+ str(pos))

output( ayudha_letter, "ayudham" )

#print mei - consonants
print("<!-- mei -->")
for pos,ta_letters in enumerate(mei_letters):
    print(ta_letters)
    output( ta_letters, "mei_"+ str(pos))
